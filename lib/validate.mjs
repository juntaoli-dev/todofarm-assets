...
export async function validate(bytes, spec) {
  ...
  add('png.colorType', m.color === 6, 'PNG-32 (colour type 6, RGBA)', COLOUR_TYPE[m.color] || m.color, false,
    ...
    : m.color === 3 ? 'Your sprite is in Indexed colour mode. In Aseprite: Sprite menu > Color Mode > RGB Color, then re-export.'
    : 'Export as a 32-bit RGBA PNG.');
